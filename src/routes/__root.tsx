...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sri Sri Puri Jagannath Temple, ISKCON Kurnool, is a spiritual center offering daily worship, devotion, cultural programs, and teachings of Krishna consciousness" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ISKCON Kurnool" },
      { property: "og:description", content: "Sri Sri Puri Jagannath Temple, ISKCON Kurnool, is a spiritual center offering daily worship, devotion, cultural programs, and teachings of Krishna consciousness" },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/iskcon-logo.png" },
      { rel: "preload", href: "/iskcon-logo.png", as: "image" },
