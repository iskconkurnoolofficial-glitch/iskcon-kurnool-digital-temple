  ...
  return (
    <section id="welcome" className="relative py-20 md:py-28 bg-surface overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center animate-fade-up">
        <span className="divider-gold text-secondary font-medium uppercase text-xs tracking-[0.3em]">Sri Sri Jagannath</span>
        <h2 className="font-display font-bold text-5xl md:text-7xl text-primary mt-6 mb-3">Hare Krishna!</h2>
        <h3 className="font-display text-2xl md:text-3xl text-foreground/80 mb-8">Welcome to ISKCON Kurnool</h3>
        <p className="text-lg leading-relaxed text-muted-foreground max-w-3xl mx-auto">
          ...
          has come to receive your love and to fill your lives with His divine grace. As devotees of the Lord we
          are here to serve you and look forward to welcoming you at our temple.
        </p>
