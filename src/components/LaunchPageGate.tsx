      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-6 max-w-4xl mx-auto py-12 space-y-10">
        ...
        <div className="space-y-4">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 text-white/80 font-sans tracking-wide text-sm sm:text-base md:text-lg mt-3"
          >
            <span>Designed and Developed by</span>
            <span className="font-bold text-secondary">Devesh</span>
