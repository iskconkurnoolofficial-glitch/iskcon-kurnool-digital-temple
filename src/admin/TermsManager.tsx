...
import { useAdmin, TermsData, TermsSection, defaultTerms } from "@/context/AdminContext";
...
export default function TermsManager() {
  const { terms, setTerms } = useAdmin();
  const [data, setData] = useState<TermsData>(() => terms || defaultTerms);
  ...
  const handleSave = async () => {
    ...
    try {
      await setTerms(data);
      toast.success("Terms & Conditions successfully saved to database!");
    } catch (err: any) {
  ...
  const handleReset = () => {
    if (window.confirm("Are you sure you want to reset all Terms & Conditions to the official default template? Any unsaved edits will be lost.")) {
      setData(defaultTerms);
      setTerms(defaultTerms);
      toast.success("Terms & Conditions reset to official template!");
    }
  };
  ...
  const handleAddSection = () => {
    ...
    const newSec: TermsSection = {
      ...
      content: "Enter your terms and policy details here.",
    };
    setData((prev) => ({
      ...prev,
  ...
  const handleUpdateSection = (id: string, field: keyof TermsSection, value: string) => {
    setData((prev) => ({
      ...prev,
    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-16 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-200 text-purple-900 text-xs font-bold uppercase tracking-wider">
            <FileText className="h-3.5 w-3.5 text-[#5b2c9b]" />
            <span>Legal &amp; Policy Management</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
            Terms &amp; Conditions Manager
          </h1>
          <p className="text-sm text-slate-500">
            Manage, customize, and edit the official public Terms &amp; Conditions page with live instant sync.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            title="Reset to default official terms template"
          >
      ...
      <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-5">
        <h2 className="text-base font-bold text-slate-900 flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <span>Page Introduction &amp; Versioning</span>
        </h2>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Welcome to the official website of ISKCON Kurnool..."
                ...
                <div className="px-5 pb-5 pt-1 border-t border-slate-100 space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      placeholder="Write policy terms, rules, and details..."
      ...
      <div className="sticky bottom-6 flex items-center justify-between p-4 rounded-2xl bg-slate-900/95 backdrop-blur-md text-white shadow-2xl border border-white/10 z-30">
        <div className="flex items-center gap-2 text-xs text-slate-300">
          ...
          <span>Keep your public terms up to date with legal standards.</span>
        </div>
